...
- This project uses [Maple Mono](https://font.subf.dev/zh-cn/) as the monospace font and [jf open 粉圓 (open huninn)](https://justfont.com/huninn/) as the standard font. Both are distributed under the OFL 1.1 license, with license texts available at `licenses/LICENSE-maple-mono.txt` and `licenses/LICENSE-jf-openhuninn.txt` respectively. [LXGW WenKai](https://github.com/lxgw/LxgwWenKai) (`licenses/OFL.txt`) is kept in the repository as an alternative standard font.
